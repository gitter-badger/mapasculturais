...
<div class="lista">
    <article class="objeto espaco clearfix">
        <h1><a href="<?php echo $this->controller->createUrl('single')?>">Título superlongo do espaço bem comprido demais pra caramba pra xuxu</a></h1>
        <div class="objeto-content clearfix">
			...
			<div class="objeto-meta">
				<div><span class="label">Tipo:</span> <a href="#">Cinema</a></div>
				<div><span class="label">Área de atuação:</span> <a href="#">Cinema</a></div>
