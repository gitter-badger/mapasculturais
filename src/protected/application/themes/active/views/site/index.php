...
<section id="capa-intro" class="js-page-menu-item objeto-capa clearfix fundo-laranja">
    <div class="box">
        ...
        <p class="textcenter"><a class="button  button--large" href="<?php echo $app->createUrl('panel') ?>">Colabore com o SP Cultura</a></p>
    </div>
...
<article id="capa-eventos" class="js-page-menu-item objeto-capa clearfix fundo-verde">
    ...
    <div class="box">
        ...
        <?php endif; ?>
        <a class="button  button--large" href="<?php echo $url_search_events ?>">Ver Eventos da Semana</a>
        <a class="button  button--large  button--ghost" href="<?php echo $app->createUrl('event', 'create') ?>">Adicionar Evento</a>
    </div>
</article>
...
<article id="capa-agentes" class="js-page-menu-item objeto-capa clearfix fundo-azul">
    ...
    <div class="box">
        ...
        <?php endif; ?>
        <a class="button  button--large" href="<?php echo $url_search_agents ?>">Ver Agentes</a>
        <a class="button  button--large  button--ghost" href="<?php echo $app->createUrl('agent', 'create') ?>">Adicionar Agente</a>
    </div>
</article>
...
<article id="capa-espacos" class="js-page-menu-item objeto-capa clearfix fundo-rosa">
    ...
    <div class="box">
        ...
        <?php endif; ?>
        <a class="button  button--large" href="<?php echo $url_search_spaces ?>">Ver Espaços</a>
        <a class="button  button--large  button--ghost" href="<?php echo $app->createUrl('space', 'create') ?>">Adicionar Espaço</a>
    </div>
</article>
...
<article id="capa-projetos" class="js-page-menu-item objeto-capa clearfix fundo-vermelho">
    ...
    <div class="box">
        ...
        <?php endif; ?>
        <a class="button  button--large" href="<?php echo $url_search_projects ?>">Ver Projetos</a>
        <a class="button  button--large  button--ghost" href="<?php echo $app->createUrl('project', 'create') ?>">Adicionar Projeto</a>
    </div>
</article>
