...
<div class="lista">
    <article class="objeto agente clearfix">
        <h1><a href="<?php echo $this->controller->createUrl('single')?>">Título superlongo do agente bem comprido demais pra caramba pra xuxu</a></h1>
        <div class="objeto-content clearfix">
			...
			<div class="objeto-meta">
				<div><span class="label">Tipo:</span> <a href="#">Individual</a></div>
				<div><span class="label">Área de atuação:</span> <a href="#">Teatro</a></div>
				<div><span class="label">Site:</span> <a href="#">mussum.com.br</a></div>				
            </div>
        </div>
    </article>
    <!--.objeto-->
